...
<head>
		<title>Ücretsiz DNS Hizmeti » TS3.WEB.TR</title>
		
		

		<meta content="freedns, tsdns, ts3 dns, ts dns, dns" name="keywords">
		<meta content="TS3.WEB.TR, Ücretsiz DNS Hizmeti. Sunucularınızı ücretsiz DNS kullanarak yönlendirebilirsiniz." name="description">
		<meta name="author" content="HasanAtilan.com">
		<meta name="copyright" content="HasanAtilan.com">
		<meta name="rating" content="General">
		<meta name="revisit-after" content="5 days">
		<meta name="robots" content="ALL">
		<meta name="distribution" content="Global">
		<meta http-equiv="Content-Language" content="tr">
		<meta http-equiv="reply-to" content="info@hasanatilan.com">
			...
			<nav class="navbar navbar-inverse">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="http://nepix.net/">
							<i class="fa fa-headphones"></i> dns<span style="color: #008cba;">.ts3.web.tr</span>						</a>
					</div>
					<div class="collapse navbar-collapse" id="bs-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">

							<li>
								<a href="http://nepix.net/">
									Ana Sayfa								</a>
							</li>
							<li>
								<a href="portal/kayit.php">
									Forum Sitemiz								</a>
							</li>		
							
							<li>
								<a href="portal/giris.php">
									TSDNS								</a>
							</li>
							
							<li>
								<a href="http://facebook.com/nepix">
									Facebook Sayfamız								</a>
							</li>
																					<li class="dropdown">
...
<div id="js-alertBox" class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6"><div class="alert alert-danger"><p><b><i class="fa fa-times"></i></b> Lütfen IP Adresini boş bırakmayın</p><p><b><i class="fa fa-times"></i></b> Lütfen Port numarasını boş bırakmayın</p></div></div>
...
<button class="btn btn-register" name="kbaslat" type="submit">Oluştur</button>
			...
			<section class="main-content bg-light">
				<div class="container text-center">
					...
					<p>TS3.WEB.TR Hizmetlerini kullandığınız için teşekkür ederiz</p><p>TS3.WEB.TR DNS Hizmeti tamamen ücretsiz ve tüm insanlığa açık bir hizmettir.</p><p>Düşünceleriniz, önerileriniz ve eleştirileriniz bizim için çok önemlidir. İletişim seçeneklerimizden bize bildirim yapabilirsiniz.</p>				</div>
			</section>
		...
		<footer>
			<div class="container">
				<div class="row">
					<div class="col-sm-6">
						<h4>
							TSBakkali Hakkında						</h4>
						<p>
							TSBakkali forumunun dağıttığı TSV2 yazılımı çok pratik ve hızlıdır. ts3 üzerinden çalışan bu yazılım, tamamen ücretsiz, kolay ve hızlı kullanım ile TSBakkali.net güvencesiyle hizmetinizdedir..						</p>
					</div>
					<div class="col-sm-3">
						<h4>
							Destek						</h4>
						...
						<ul>
							<li>
								<a href="https://facebook.com/" target="_blank">
									<i class="fa fa-facebook-official" aria-hidden="true"></i>ᅠ@tsbakkal
								</a>
							</li>
							<li>
								<a href="mailto:info@tsbakkali.net" target="_blank">
									<i class="fa fa-envelope-o" aria-hidden="true"></i>ᅠinfo@tsbakkali.net (
									Destek)
								</a>
							</li>
							<li>
				...
				<hr>
					<div class="row copyline">
						<div class="col-sm-6">
							<p>Copyright © 2016 dns.ts3.web.tr - 
								Tüm hakları mahfuzdur ve mahfuz acı verir..							</p>

						</div>
						<div class="col-sm-6 text-right">
							<p>
								<a href="https://tsbakkali.net">
									Gizlilik								</a>
							</p>
						</div>
					</div>
