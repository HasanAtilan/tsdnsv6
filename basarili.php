...
<div id="js-alertBox" class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6"><div class="alert alert-success"><p><b><i class="fa fa-check"></i></b> <? echo strtolower(umlautepas($_POST[subname])).'.'.$domain.''; ?></b></a></p></div></div>
